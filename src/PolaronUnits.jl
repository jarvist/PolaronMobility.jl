...
function addunits!(polaron::FrohlichPolaron; unit="pu")
    ...
    polaron.Rs = pustrip.(polaron.Rs ./ sqrt.(2 .* polaron.mb .* polaron.ωeff)) .* punit(1Unitful.Å)
    polaron.Rl = pustrip.(polaron.Rl ./ sqrt.(2 .* polaron.mb .* polaron.ωeff)) .* punit(1Unitful.Å)
    ...
    polaron.R0 = pustrip.(polaron.R0 ./ sqrt.(2 .* polaron.mb)) .* punit(1Unitful.Å)
    ...
    polaron.R = pustrip.(polaron.R ./ sqrt.(2 .* polaron.mb)) .* punit(1Unitful.Å)
...
function addunits!(polaron::HolsteinPolaron; unit="pu")
    ...
    polaron.v0 = phustrip.(polaron.v0 .* polaron.J ./ 2π) .* phunit(1Unitful.THz)
    polaron.w0 = phustrip.(polaron.w0 .* polaron.J ./ 2π) .* phunit(1Unitful.THz)
    polaron.κ0 = phustrip.(polaron.κ0 .* (polaron.J ./ 4π) ./ polaron.a^2) .* phunit(1u"N/m")
    polaron.M0 = phustrip.(polaron.M0 ./ polaron.a .^2 ./ polaron.J ./ 2) .* phunit(1Unitful.me)
    polaron.M0a = phustrip.(polaron.M0a ./ polaron.a .^2 ./ polaron.J ./ 2) .* phunit(1Unitful.me)
    polaron.M0r = phustrip.(polaron.M0r ./ polaron.a .^2 ./ polaron.J ./ 2) .* phunit(1Unitful.me)
    polaron.R0 = phustrip.(polaron.R0 .* polaron.a ./ sqrt(polaron.γ)) .* phunit(1Unitful.Å)
    ...
    polaron.v = phustrip.(polaron.v .* polaron.J ./ 2π) .* phunit(1Unitful.THz)
    polaron.w = phustrip.(polaron.w .* polaron.J ./ 2π) .* phunit(1Unitful.THz)
    polaron.κ = phustrip.(polaron.κ .* (polaron.J ./ 4π) ./ polaron.a^2) .* phunit(1u"N/m")
    polaron.M = phustrip.(polaron.M ./ polaron.a .^2 ./ polaron.J ./ 2) .* phunit(1Unitful.me)
    polaron.Ma = phustrip.(polaron.Ma ./ polaron.a .^2 ./ polaron.J ./ 2) .* phunit(1Unitful.me)
    polaron.Mr = phustrip.(polaron.Mr ./ polaron.a .^2 ./ polaron.J ./ 2) .* phunit(1Unitful.me)
    polaron.R = phustrip.(polaron.R .* polaron.a ./ sqrt(polaron.γ)) .* phunit(1Unitful.Å)
    polaron.μ = phustrip.(polaron.μ .* polaron.a .^2) .* phunit(1u"cm^2/V/s")
    polaron.χ = phustrip.(polaron.χ ./ (polaron.a .^2) ./ 2π) .* phunit(u"Ω") .* phunit(1Unitful.THz)
    polaron.z = phustrip.(polaron.z ./ (polaron.a .^2)) .* phunit(u"Ω")
    polaron.σ = phustrip.(polaron.σ * polaron.a .^2) .* phunit(u"S")
