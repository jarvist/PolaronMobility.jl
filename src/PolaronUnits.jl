...
function addunits!(polaron::HolsteinPolaron; unit="pu")
    ...
    polaron.v0 = phustrip.(polaron.v0 ./ 2π) .* phunit(1Unitful.THz)
    polaron.w0 = phustrip.(polaron.w0 ./ 2π) .* phunit(1Unitful.THz)
    ...
    polaron.R0 = phustrip.(polaron.R0 ./ sqrt.(2 .* polaron.mb .* 2π)) .* phunit(1Unitful.Å)
    ...
    polaron.v = phustrip.(polaron.v ./ 2π) .* phunit(1Unitful.THz)
    polaron.w = phustrip.(polaron.w ./ 2π) .* phunit(1Unitful.THz)
    ...
    polaron.R = phustrip.(polaron.R ./ sqrt.(2 .* polaron.mb .* 2π)) .* phunit(1Unitful.Å)
    polaron.μ = phustrip.(polaron.μ .* polaron.a .^2) .* phunit(1u"cm^2/V/s")
    polaron.χ = phustrip.(polaron.χ .* polaron.mb) .* phunit(u"Ω") .* phunit(1Unitful.THz)
    ...
    polaron.Ω = phustrip.(polaron.Ω ./ 2π) .* phunit(1Unitful.THz)
